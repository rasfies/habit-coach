...
// ---------------------------------------------------------------------------
// Bottom nav items (4 main + settings)
// ---------------------------------------------------------------------------
...
const navItems = [
  {
    ...
    label: "Home",
    icon: (active: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={active ? "currentColor" : "none"} stroke={active ? "none" : "currentColor"} strokeWidth={1.8} className="h-6 w-6" aria-hidden="true">
...
export function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-[200] border-t border-neutral-200 bg-white/95 backdrop-blur-sm md:hidden"
